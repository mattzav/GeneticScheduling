...
\begin{itemize}
	...
	\end{enumerate}
	Note that for each couple of permutations $(P(N_A),P(N_B))$, the generation process outputs a different schedule. This guarantees a \textit{diversification} in the initial population.
\end{itemize}
